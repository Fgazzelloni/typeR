...
This outlines how to propose a change to typeR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Fgazzelloni/typeR", fork = TRUE)`.
...
Please note that the typeR project is released with a [Contributor Code
of Conduct](https://Fgazzelloni.github.io/typeR/CODE_OF_CONDUCT.md). By
