...
vignette: >
  %\VignetteIndexEntry{Live Code Execution with typeRun}
...
<center>
![typeR::typeRun demo](images/typeRun_demo.gif){width="600px" height="400px"}
</center>
...
- `summary(model)` displays the full summary with coefficients, R-squared, etc.
...
The `typeRun()` function properly displays statistical test results using their formatted print methods:
...
The same applies to other statistical objects like `anova()`, `aov()`, `lm()`, etc.
...
- `?typeRun` - Full function documentation
